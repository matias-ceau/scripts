...
def describe_script(script_content):
    print_colored("Generating description using Llama 3.1 model...", Fore.MAGENTA)
    client = Client()
    prompt = f"Please generate the github documentation (markdown format) of the following script (describe its functionalities):\n\n{script_content}"
